...
int main(){
    ...
    float b1,  b2,  bmu,  d1,  d2,  dmu,  sigma1,  sigma2,  k1pl,  k2pl,  k1min, k2min, kappa1, kappa2,  n1var,  n2var,  nmuvar,  h,  kin, kout, tfmax, tfmin, m2min, m2max, channel, fvar, MCsteps;
